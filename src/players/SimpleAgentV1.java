 ...
 */
public class SimpleAgentV1 extends Agent {
     ...
     */
    public SimpleAgentV1( long seed ) {
        super( seed );
    ...
    @Override
    public Agent copy() {
        SimpleAgentV1 player = new SimpleAgentV1( seed );
        return player;
    }
...
//        System.out.println(bestActionScore + " " + chosenAction);
     ...
     */
    public int evalAction( GameState gs , Action a ) {
