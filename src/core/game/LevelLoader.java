        ...
        for (int i = 0; i < size.height; ++i) {
            ...
            for(int j = 0; j < tile.length; ++j)
            {
                ...
                if(terrainChar == Types.TERRAIN.CITY.getMapChar())
                {
                    ...
                    // TODO:Add feature to support players with the same tribes...I assume the code is working as long
                    //  as i make sure the ids for tribes and cities are valid(different)
