...
public class Game {
    ...
    private void initGameStructures( ArrayList<Agent> players , Types.TRIBE[] tribes ) {
        ...
        // TODO:How are state observations built?
        //  Check the function at line 554 in Game.java
        this.gameStateObservations = new GameState[ numPlayers ];
    }
...
//            System.out.println("Frame closed: " + frame.isClosed());
    ...
    // TODO:Implement the game in a similar way with an RL environment from Python for an easier implementation of RL agents
